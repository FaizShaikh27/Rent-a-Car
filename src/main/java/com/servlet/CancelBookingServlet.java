...
public class CancelBookingServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Get the car_id associated with the booking
            ...
            psBooking = conn.prepareStatement(cancelBookingSql);
            psBooking.setInt(1, bookingId);
            ...
            // Redirect with the status parameter
            response.sendRedirect("bookingStatus.jsp?status=canceled");
        } catch (Exception e) {
            e.printStackTrace();
